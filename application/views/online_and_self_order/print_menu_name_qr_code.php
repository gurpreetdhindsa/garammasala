...
.label{
    width: 1.30in; /* plus .6 inches from padding */
	height: 1.30in; /* plus .125 inches from padding */
...
<div class="label" style="text-align: center;float: left">
    ...
    <?php if($value->name!='') echo "$value->name<br>"; echo $this->session->userdata('currency');echo ":$value->sale_price";  ?></p>
</div>
<?php $i++; } ?>
</body>
</html>